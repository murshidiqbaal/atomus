...
void main() {
  ...
  test(
    'Academic Performance Engine live Supabase integration and composite calculations',
    () async {
      ...
      try {
        ...
        print(
          '  - Attendance Percentage: ${performance.attendancePercentage.toStringAsFixed(2)}%',
        );
        print(
          '  - Marks Percentage: ${performance.marksPercentage.toStringAsFixed(2)}%',
        );
        print(
          '  - Composite Score: ${performance.academicPerformanceScore.toStringAsFixed(2)}%',
        );
        ...
        for (var s in performance.subjectWisePerformance) {
          ...
          print(
            '    - Attendance: ${s.attendancePercentage.toStringAsFixed(2)}%',
          );
